(function() {
  ...
  twttr.txt.linkToHashtag = function(entity, text, options) {
    ...
    if (options.cordova) {
        attrs.href = "#";
        attrs.onclick = "window.open('" + options.hashtagUrlBase + hashtag + "', '_system');"
    } else {
  ...
  twttr.txt.linkToCashtag = function(entity, text, options) {
    ...
    if (options.cordova) {
        attrs.href = "#";
        attrs.onclick = "window.open('" + options.cashtagUrlBase + cashtag + "', '_system');"
    } else {
  ...
  twttr.txt.linkToMentionAndList = function(entity, text, options) {
    ...
    var url = isList ? options.listUrlBase + user + slashListname : options.usernameUrlBase + user;
    if (options.cordova) {
        attrs.href = "#";
        attrs.onclick = "window.open('" + url + "', '_system');"
    } else {
        attrs.href = url;
    }
